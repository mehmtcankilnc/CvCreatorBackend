...
public interface ICoverLetterService
{
    ...
    Task SaveCoverLetterAsync(byte[] fileContent, string userId, CoverLetterFormValuesModel model);
    ...
    Task<(byte[] FileContent, string FileName)?> GetCoverLetterFileAsync(Guid coverLetterId, Guid currentUserId);
}
